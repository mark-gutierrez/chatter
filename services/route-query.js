...
module.exports = fp(function (fastify, opts, done) {
    class RouteResolverSingleton {
        static #instance
        #builder
        #query

        static get() {
            if (!RouteResolverSingleton.#instance) {
                RouteResolverSingleton.#instance = new RouteResolverSingleton()
                RouteResolverSingleton.#instance.initializeProperties()
            }
            return RouteResolverSingleton.#instance
        }

        initializeProperties() {
            this.#builder = fastify.q
            this.#query = ""
        }
    ...
    fastify.decorate("r", RouteResolverSingleton.get())
